...
import com.proxy.netty.codec.web.WebResponse;
...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	public void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
		...
		if (uri.equals("/") || uri.equals("/index.html")) { // index page
			ResourceLoader.getInstance().loadClassPathResource("/www/html/index.html").thenApply(WebResponse::html)
					.exceptionally(WebResponse::fromThrowable)
