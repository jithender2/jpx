...
public class TreeNode extends Item implements Serializable {
    ...
    public static final int EQUAL = Integer.MAX_VALUE;
    // means domain is super domain of host
    public static final int IS_SUPER = Integer.MAX_VALUE - 1;
    // means domain is sub domain of pattern
   public static final int IS_SUB = Integer.MAX_VALUE - 2;
    public static final int MISS = 0;

    // top domains, and not country
    public static final Set<String> topDomains = Set.of("com", "net", "org", "co");
